...
\newcommand{\tighttable}{\setlength{\tabcolsep}{11pt}\renewcommand{\arraystretch}{1.15}\small}

\begin{document}
\maketitle

\noindent\textbf{Workspace:} \texttt{DatabaseProject} \\
\textbf{Primary stack:} MySQL, pandas, scikit-learn, Plotly \\
\textbf{Scope:} Database design, data loading, feature engineering, forecasting, and reporting
...
\begin{enumerate}
  \item A MySQL-backed database layer with operational tables, dimensional tables, and reusable SQL views.
  \item A time-series modeling layer that trains a transparent \texttt{StandardScaler -> Ridge} pipeline to predict next-trading-day Brent crude prices and produces a 10-day Monte Carlo forecast.
\end{enumerate}
...
\tighttable
\centering
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{4.55cm}@{\hspace{1.1em}}r@{\hspace{1.1em}}Y@{}}
\toprule
...
\tighttable
\centering
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{4.9cm}@{\hspace{1.1em}}Y@{}}
\toprule
...
\tighttable
\centering
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{3.35cm}@{\hspace{1.1em}}Y@{}}
\toprule
...
\tighttable
\centering
\begin{tabularx}{\textwidth}{@{}l@{\hspace{1.1em}}r@{\hspace{1.1em}}r@{\hspace{1.1em}}r@{}}
\toprule
